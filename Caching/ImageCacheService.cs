...
public class ImageCacheService
{
    ...
    {
        _logger = logger;
        _cacheRoot = Path.Combine(applicationPaths.CachePath, "darkfluxqualityoverlay");
        ...
        PluginConfiguration config)
    {
        ...
        builder.Append('|').Append(config.AccentColor);
        builder.Append('|').Append(config.ResolutionTextColor);
        builder.Append('|').Append(config.RatingColor);
